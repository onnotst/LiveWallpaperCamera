    ...
    public partial class MainWindow : Window
    {
        ...
        private async void BtnSelect_Click(object sender, RoutedEventArgs e)
        {
            ...
            using (var openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    var wpModel = new WallpaperModel()
                    {
                    ...
                    var showResult = await WallpaperApi.ShowWallpaper(wpModel, displayScreen);
        ...
        private async void showCamera()
        {
            ...
            var wpModel = new WallpaperModel()
            {
                RunningData = new WallpaperRunningData()
                {
                    AbsolutePath = AppContext.BaseDirectory + "\\ViewCamera\\Exe\\ViewCamera.exe"
                }
            };
            var showResult = await WallpaperApi.ShowWallpaper(wpModel, displayScreen);
            var wp = showResult.Data;
